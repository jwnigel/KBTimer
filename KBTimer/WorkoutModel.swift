...
//    
//    init(order: Int, sets: [TimedSet], rests: [Int], completed: Bool = false) {
//        self.order = order
//        self.sets = sets
//        self.rests = rests
...
//                                                  sets: [TimedSet(minutes: 4, completed: true),
//                                                         TimedSet(minutes: 3, completed: true),
//                                                                    TimedSet(minutes: 2, completed: false),
//                                                                    TimedSet(minutes: 1, completed: false)],
//                                                  rests: [5, 5],
//                                                  completed: false))
//        
//        
